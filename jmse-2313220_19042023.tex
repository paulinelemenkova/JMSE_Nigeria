...
Thus, the~data vary from 0 to +1, unlike the typical range of $-$1 to +1 for the NDVI and other indices. Specifically, according to the histogram, for~the year 2013, the~majority of the IPVI values range from 0.50 to 0.70; for 2015, from 0.50 to 0.80 with a more sharp increase in values; for 2021, from 0.70 to 0.90; and for 2022, from 0.60 to 0.90. Thus, one can note the trend of the generally increasing higher values that indicate rainforests while the area of mangroves declines. The~mangroves are depicted by the dark blue colors, gradually replaced by the areas of light green color when comparing the data for 2013 with other years and, specifically, 2022, Figure~\ref{fig11}.%mdpi: We changed 0,60 to 0.60, please confirm. % <- Authors' reply: yes, we confirm.
