...
\end{equation}
%mdpi: The italics of the formula is not consistent with maintext,  please confirm whether to unify into italics. Please check whole tex and revise it. Following highlights are the same. % <- Authors' reply: corrected. The italics is unified with main text throughout
