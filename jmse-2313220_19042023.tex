...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{EVI computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig12}
