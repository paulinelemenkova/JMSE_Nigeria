...
\begin{figure}[H]
	...
	\caption{Topographic map of Nigeria with indicated study area. Yellow dots indicate cities, red pentagram indicates a capital. Software: Generic Mapping Tools (GMT) version 6.1.1, ref.~\cite{Wessel}. Data source: GEBCO/SRTM~\cite{GEBCO,SRTM}. Cartography source: authors.
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{ARVI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig04}
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{GARI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig05}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{GVI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig06}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{PVI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig07}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{GEMI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig08}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
The values of the \emph{NDWI} range from $-$0.90 to $-$0.70 in 2013, and from~$-$0.90 to $-$0.50 according to the sideway histograms visualized in Figure~\ref{fig09}. 
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{NDWI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig09}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
The computed \emph{MSAVI2} is visualised in Figure~\ref{fig10}. 
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{MSAVI2} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig10}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{IPVI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig11}
\end{figure}%mdpi: Please change the hyphen (-) into a minus sign (−, “U+2212”), e.g., “-1” should be “−1”.; The caption is duplicated, please confirm if the year on the figure can be deleted.
...
\hspace{-32pt}\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.55\textwidth}
		...
		\caption{\centering}
	\end{subfigure}%
}\caption{\emph{EVI} computed from the Landsat 8-9 OLI/TIRS images of Niger River Delta for four years: (\textbf{a}) 2013, (\textbf{b}) 2015 (\textbf{c}) 2021, (\textbf{d}) 2022.}\label{fig12}
...
This paper demonstrated that the scripting techniques of the GRASS GIS used with freely-available Landsat OLI/TIRS satellite images are beneficial for evaluating the spatial patterns in the vegetation areas of coastal Nigeria. The~results obtained from the satellite image processing and computing the VI for assessing mangrove distribution show that \emph{MSAVI2} (Figure \ref{fig10}) and \emph{GVI} (Figure \ref{fig06}) indices ranked the highest with the most accurate presented areas of the mangrove fields, while \emph{EVI} (Figure \ref{fig12}) and \emph{GEMI} (Figure \ref{fig08}) were judged to rank the lowest. Changes in mangrove fields for the four different time periods estimated by the atmospherically adjusted indices \emph{ARVI} and \emph{GARI} are presented in Figure~\ref{fig04} and Figure~\ref{fig05}, showing the VI corrected for the atmospheric effects. Here the distribution of the mangrove fields (showed by the light orange colors) recorded the highest value in 2013, while the lowest value was in 2022 due to the declined area of distribution of mangrove habitats, as~discussed above. The~\emph{DVI} (Figure \ref{fig03}) and \emph{PVI} (Figure \ref{fig07}) indices demonstrated the comparable results with visible reduction of mangroves, showed as the reduced area in both the \emph{PVI} and \emph{DVI}. Nevertheless, the~use of the \emph{DVI} is less effective for mapping mangroves and densely vegetated areas of tropical forests, since this index is better identifies urban areas and settlements. The~\emph{NDWI} (Figure \ref{fig09}) and the \emph{IPVI} (Figure \ref{fig11}) also highlighted the decline of mangrove swamps as areas in the lower left segment of the images colored in yellow-green for the \emph{NDWI} and light blue for the~\emph{IPVI}.
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{ARVI}.,style=mystyle,label={lst02}]
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{GARI}.,style=mystyle,label={lst03}]
g.region raster=lsat8_2013_toar.3 -p
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{GVI}.,style=mystyle,label={lst04}]
g.region raster=lsat8_2013_toar.3 -p
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{DVI}.,style=mystyle,label={lst05}]
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{PVI}.,style=mystyle,label={lst06}]
g.region raster=lsat8_2013_toar.1 -p
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{GEMI}.,style=mystyle,label={lst07}]
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{NDWI}.,style=mystyle,label={lst08}]
g.region raster=lsat8_2013_toar.1 -p
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{MSAVI2}.,style=mystyle,label={lst09}]
g.region raster=lsat8_2013_toar.1 -p
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{IPVI}.,style=mystyle,label={lst10}]
g.region raster=lsat8_2013_toar.1 -p
...
\begin{lstlisting}[language=bash,caption=GRASS GIS script for computing the \emph{EVI}.,style=mystyle,label={lst11}]
g.region raster=lsat8_2013_toar.1 -p
