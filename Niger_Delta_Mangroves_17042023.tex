...
%----------- section ----------->
\section{Results}
The results of the image processing show that the proposed GRASS GIS framework of scripting methods is effective for mapping the VI in western segment of the Niger River Delta. The evaluation of the VI is useful for the comparative assessment of vegetation patterns and environmental monitoring in coastal Nigeria. In this section, we evaluate the results of the implementation of various VI and maps visualised and compared on several years for the target region. The sidewise histograms placed on the left of the legend in each of the image demonstrate the data distribution with the study area for each index.
