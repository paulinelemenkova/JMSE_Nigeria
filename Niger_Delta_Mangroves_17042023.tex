...
In this section, we compare and discuss the results of the computed VI with regard to their performance and suitability to identify mangrove habitats and to discriminate them against other land cover types along the coasts of southern Nigeria. The results of the implementation of various VI and maps were visualised and evaluated on several years for the target region of the western segment of the Niger River Delta. Sidewise histograms placed on the left of the legend in each of the image demonstrate the data distribution with the study area for each index. The results are obtained using the GRASS GIS framework aimed at image processing and analysis. To produce the colour-consistent images and evaluate the spatio-temporal changes, the maps derived from the computed vegetation indices were visualised in the identical colour ranges for each set of the four images. 

Ten diverse vegetation indices were calculated with aim to find the variations in the distribution of the vegetation patterns and in particular, mangrove habitats of the coastal Nigeria. Computing the vegetation indices using algorithms embedded in 'i.ivi' and scripting approach is integrated consistently for the comparative analysis of time series of the Landsat 8-9 OLI/TIRS images covering the Niger River Delta. The results demonstrated that scripting methods of the GRASS GIS are effective for mapping the VI in topical regions. The evaluation of the VI is useful for the comparative assessment of vegetation patterns and environmental monitoring in coastal Nigeria. 
%----------- subsection ----------->
\subsection{Difference Vegetation Index (DVI)}
