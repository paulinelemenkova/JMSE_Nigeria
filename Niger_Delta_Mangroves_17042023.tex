...
In this section, we compare and discuss the results of the computed VI with regard to their performance and suitability to identify mangrove habitats and to discriminate them against other land cover types along the coasts of southern Nigeria. The results are obtained using the GRASS GIS framework aimed at image processing and analysis. Various VI were visualised in maps and evaluated on several years for the target region in the western segment of the Niger River Delta. Sidewise histograms placed on the left of the legend in each of the image demonstrated data distribution within the study area for each index. To produce the colour-consistent images and evaluate the spatio-temporal changes, these maps were derived from the computed vegetation indices and visualised in the identical colour ranges for each set of the four images. 
