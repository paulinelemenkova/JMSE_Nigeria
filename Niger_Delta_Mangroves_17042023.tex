...
\abstract{
This paper addresses the issue of \textcolor{blue}{the }satellite image processing \textcolor{blue}{using GRASS GIS }in \textcolor{blue}{the }mangrove forests of \textcolor{blue}{the }Niger \textcolor{blue}{River }Delta, southern Nigeria. The estuary of the Niger Delta in the Gulf of Guinea is an essential hotspot of biodiversity in western coast of Africa. At the same time, \textcolor{blue}{ climate }issues and  \textcolor{blue}{anthropogenic factors pose affect vulnerable coastal ecosystems and result in rapid decline of mangrove habitats. This motivates monitoring of the vegetation patterns by the advanced cartographic methods and data analysis. As a response to this need, this study aims at calculating and mapping several }vegetation indices (VI) using scripts \textcolor{blue}{ as advanced} programming \textcolor{blue}{methods} integrated in geospatial studies. The data include four Landsat 8-9 OLI/TIRS images covering the western segment of the Niger Delta in the Bight of Benin for 2013, 2015, 2021 and 2022. \textcolor{blue}{The techniques} include the \emph{i.vi}, \emph{i.landsat.toar} and other modules of \textcolor{blue}{the }GRASS GIS. Based on the GRASS GIS \emph{i.vi} module, ten VI are computed and mapped for the western segment of the Niger Delta estuary: Atmospherically Resistant Vegetation Index (ARVI), Green Atmospherically Resistant Vegetation Index (GARI), Green Vegetation Index (GVI), Difference Vegetation Index (DVI), Perpendicular Vegetation Index (PVI), Global Environmental Monitoring Index (GEMI), Normalized Difference Water Index (NDWI), Second Modified Soil Adjusted Vegetation Index (MSAVI2), Infrared Percentage Vegetation Index (IPVI) and Enhanced Vegetation Index (EVI). The \textcolor{blue}{results} showed variations in the vegetation \textcolor{blue}{patterns in mangrove habitats situated in} the Niger Delta over \textcolor{blue}{the last} decade \textcolor{blue}{as well as the increase in } urban \textcolor{blue}{areas} (Onitsha, Sapele, Warri and Benin City) and \textcolor{blue}{settlements} in the Delta State \textcolor{blue}{due to} urbanisation. \textcolor{blue}{The advanced techniques of the GRASS GIS of satellite image processing and analysis enabled to identify and visualise} changes in vegetation \textcolor{blue}{patterns}. \textcolor{blue}{Technical excellence} of the GRASS GIS \textcolor{blue}{in image processing and analysis is} demonstrated \textcolor{blue}{in the scripts used in this study}. 
}
...
Mangroves \hl{are} a unique halophyte type of \hl{the shrubs and }forests \hl{that have a unique} complex root system with prop roots \cite{Numbere}. \hl{Mangroves exist only} in \hl{the }saline waters of \hl{the }intertidal \hl{coastal zone of }tropics and subtropics. \hl{Southern Nigeria, located along the tropical coasts of the Atlantic Ocean, has favourable environmental and climate setting for mangrove distribution. In particular, the Niger River Delta has} the most extensive area of mangroves in West Africa \cite{KINAKO197735}, and\hl{ it is }the third largest wetland in the world \cite{ZABBEY2021100571}. \hl{A wide variety of mangrove }species \hl{are} adapted to the environmental setting \hl{of Nigeria }\cite{Ukpong1991,Ufuoma}. \hl{For instance, the} Niger River Delta (Figure \ref{fig01}) provides \hl{a habitat for \emph{Rhizophora} which is the most common species located along the coasts, or shrub genera \emph{Avicennia} and \emph{Laguncularia} that growth in the lagoon areas of southern Nigeria} \cite{Akpovwovwo}. The dynamics of mangrove \hl{habitats} and \hl{the }distribution of \hl{these species depend on various factors:} salinity \cite{Amadi,Okafor,Ukpong1997}, distance from coast, \hl{repeatability of }tidal cycles and freshwater inflow. \hl{Other factors include landscape characteristics that vary in the }coastal ecosystems \hl{of} southern Nigeria\hl{ in the} lagoon, mud beach, the Niger River Delta and \hl{in }the coastal areas \hl{that extend along the coasts of the Bight of Benin in the Gulf of Guinea} \cite{Ajao}. \hl{The mangrove forests have a year-round growing season which continuous vegetation cycle in the mangrove development which includes opening the forest canopy, growing rapidly young trees, and mature phase formed by the large trees} \cite{Whitmore}.
...
\hl{Among all the existing Landsat products, the Landsat OLI/TIRS sensor has improved technical and spectral characteristics: narrower spectral bands including Red and NIR channels which are crucial for calculation of the VI. Moreover, it has better calibration, higher radiometric resolution and corrections signal for noise. A thorough comparative analysis of the Landsat OLI/TIRS against earlier sensors is presented in }\cite{ROY201657}. \hl{Since spectral characteristics of the older Landsat products (TM and MSS) have coarser parameters, we only used the images obtained from the Landsat OLI/TIRS. At the same time, the first Landsat 8 OLI/TIRS sensor was launched on 2013, which explains the choice of the first image selected in this study. Another important parameter for data selection was low cloudiness of the images and comparable span for a short time series. }
