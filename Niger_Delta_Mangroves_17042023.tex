...
The heat map graph shows the confusion matrix plotted using Python showing the probability cases for pixel distribution according to land cover classes (10 selected ID classes) in the Niger Delta, Nigeria, Figure \ref{fig13}. 
