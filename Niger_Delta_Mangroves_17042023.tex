...
The DVI is visualised in Figure \ref{fig03}. 
...
The DVI (Figure \ref{fig03}) is a slope-based type of VI which is more straightforward to compute compared to the NDVI, which is beneficial for mangroves since they are located at the interface between land and sea. The DVI is sensitive to the total content of vegetation and density of canopy. Moreover, it well distinguishes the areas between the bare soil and vegetation canopies in general and identifies urban areas in the small settlements.
...
The ARVI (Figure \ref{fig04}) is designed for the regions of high atmospheric aerosol content as a robust modification of the NDVI. 
